...
<body class="text-center">
    ...
    <form action="register.php" method="post">
      ...
      <br>
      <br>
      Passwort_Wiederholen: <input type="password" name="passwort_wiederholen" size="10">
      <br>
      <br>
      <input class="w-40 btn btn-lg btn-primary" type="submit" name="submit" value="Erstellen">
    </form>
    <br>
